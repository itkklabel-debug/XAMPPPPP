    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link <?= ($current_page == 'index.php' && $current_dir == $folder_name) ? 'active' : '' ?>" href="<?= BASE_URL ?>/index.php">
                        <i class="bi bi-speedometer2 me-1"></i>Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_dir == 'barang' ? 'active' : '' ?>" href="<?= BASE_URL ?>/barang/index.php">
                        <i class="bi bi-archive me-1"></i>Barang
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_dir == 'barang_masuk' ? 'active' : '' ?>" href="<?= BASE_URL ?>/barang_masuk/index.php">
                        <i class="bi bi-box-arrow-in-down me-1"></i>Masuk
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_dir == 'barang_keluar' ? 'active' : '' ?>" href="<?= BASE_URL ?>/barang_keluar/index.php">
                        <i class="bi bi-box-arrow-up me-1"></i>Keluar
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_dir == 'pengajuan' ? 'active' : '' ?>" href="<?= BASE_URL ?>/pengajuan/index.php">

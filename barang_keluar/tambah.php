...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$id_barang || $jumlah <= 0 || empty($tanggal)) {
        ...
        $stok_result = mysqli_query($conn, "SELECT stok FROM barang WHERE id = $id_barang");
        $stok_row = mysqli_fetch_assoc($stok_result);

        if (!$stok_row) {
            $error = 'Barang tidak ditemukan.';
        } elseif ($stok_row['stok'] < $jumlah) {
            $error = 'Stok tidak mencukupi! Stok tersedia: ' . $stok_row['stok'] . ' unit.';
        } else {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                header('Location: ' . BASE_URL . '/barang_keluar/index.php?msg=added');
                exit;
            } else {
...
<div class="content-wrapper">
    <div class="container">
        <div class="page-header">
            <h2><i class="bi bi-box-arrow-up me-2"></i>Input Barang Keluar</h2>
            <p>Catat barang keluar untuk mengurangi stok</p>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="form-custom">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?= BASE_URL ?>/barang_keluar/index.php" class="btn btn-outline-custom">
